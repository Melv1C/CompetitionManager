  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Track your organization's performance and insights.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg border p-4">
          ...
          <p className="text-xs text-muted-foreground">Average satisfaction rate</p>
        </div>
        <div className="rounded-lg border p-4">
